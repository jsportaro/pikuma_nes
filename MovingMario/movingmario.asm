...
CheckRightButton:
    lda Buttons
    and #%00000001           ; Perform a bitwise AND with the accumulator
...
CheckLeftButton:
    lda Buttons
    and #%00000010           ; Perform a bitwise AND with the accumulator
...
CheckDownButton:
    lda Buttons
    and #%00000100           ; Perform a bitwise AND with the accumulator
...
CheckUpButton:
    lda Buttons
    and #%00001000           ; Perform a bitwise AND with the accumulator
